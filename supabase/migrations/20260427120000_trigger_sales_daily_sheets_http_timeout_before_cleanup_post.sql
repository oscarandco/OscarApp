-- pgsql-http defaults to ~5s per request; after the first http_post (Edge import) curl options may reset.
-- Re-apply http.curlopt_timeout_ms = 60s immediately before the second http_post (cleanup_storage_only).
