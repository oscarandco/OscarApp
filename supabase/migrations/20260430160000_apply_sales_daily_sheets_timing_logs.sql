-- Observability: RAISE LOG timings inside apply_sales_daily_sheets_to_payroll (prefix: sds_timing).
-- Business logic unchanged from 20260423120000_apply_sales_daily_sheets_location_scoped_replace.sql.
