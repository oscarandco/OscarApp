-- Retail on Wage: payable name = work staff when line would be commission_category_final retail_product
-- (same exclusions + master-type logic as retail_product branch). Assistant / INTERNAL / other rules unchanged.
