-- Disable transaction-local statement_timeout for apply_sales_daily_sheets_to_payroll (large INSERT…SELECT + load_raw_sales_rows_to_transactions).
-- Supersedes timing-only body from 20260430160000_apply_sales_daily_sheets_timing_logs.sql; business logic unchanged.
