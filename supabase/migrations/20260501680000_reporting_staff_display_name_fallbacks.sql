-- Reporting: display-name fallbacks when staff_members lateral joins miss historical names.
-- Keeps 20260431500000 wage/retail parity logic; adds COALESCE to raw sales_transactions text columns.
-- Also refreshes v_commission_calculations_core (Stylist Paid label) and v_sales_transactions_enriched (KPIs / drilldowns).
