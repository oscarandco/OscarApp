-- Speed up and let delete_all_sales_daily_sheets_import_data finish: disable statement_timeout
-- for this transaction, use USING deletes, TRUNCATE SDS-only staging tables.
