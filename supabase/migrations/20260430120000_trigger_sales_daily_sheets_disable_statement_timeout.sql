-- Long Edge http_post + merge can exceed default statement_timeout; disable for this RPC only (transaction-local).
-- Keeps extensions.http_set_curlopt('CURLOPT_TIMEOUT_MS', '60000') before http_post.
