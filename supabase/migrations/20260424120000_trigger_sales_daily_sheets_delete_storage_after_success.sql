-- After a successful Edge + merge import, remove the uploaded CSV from storage.objects for this path only.
-- If DELETE fails, import still succeeds; RAISE WARNING for logs and note on import batch message.
    ...
    BEGIN
      ...
      EXCEPTION
        WHEN OTHERS THEN
          ...
          RAISE WARNING 'trigger_sales_daily_sheets_import: could not delete storage object %: %', v_path, SQLERRM;
      END;
